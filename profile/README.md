...
'똑부러지는 취업, 똑바른 자세부터 똑똑'은 시선, 자세, 음성 분석을 활용하여 사용자의 면접 태도를 객관적으로 평가하는 AI 기반 모의면접 서비스입니다. </br>
...
▪️ 시선, 자세, 음성 요소를 종합 분석하여 실제 면접 환경과 유사한 경험을 제공한다.<br>
...
#### ◾ 면접 결과 리포트
>**by BBoglePops** <br/>
시선 분석, 자세 분석, 음성 분석 결과를 종합하여 면접 결과 리포트를 생성한다.<br>
...
▪️ 시선, 자세, 음성 데이터를 기반으로 실질적인 면접 역량 향상이 가능하다.<br>
